...
@Entity
@Table(name = "limited_liability_pre_principal")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class LimitedLiabilityPrePrincipal {
    ...
    @JoinColumn(name = "limited_liability_pre_id", nullable = false)
    private LimitedLiabilityPre limitedLiabilityPre;
